 ...
 */
public class OdometryGlobalCoordinatePosition3e implements Runnable{
    //Odometry wheels
     ...
     * verticalEncoderLeft left odometry encoder, facing the vertical direction
     * verticalEncoderRight right odometry encoder, facing the vertical direction
     * horizontalEncoder horizontal odometry encoder, perpendicular to the other two odometry encoder wheels
     * @param robot SandsRobot that holds all the encoder motors
     * @param threadSleepDelay delay in milliseconds for the GlobalPositionUpdate thread (50-75 milliseconds is suggested)
     */
    public OdometryGlobalCoordinatePosition3e(SandsRobot robot, double COUNTS_PER_INCH, int threadSleepDelay){
        this.verticalEncoderLeft = robot.verticalLeftEncoder;
        this.verticalEncoderRight = robot.verticalRightEncoder;
        this.horizontalEncoder = robot.horizontalEncoder;
